            ...
            <table id="players" class="table table-striped table-bordered table-hover">
              ...
              <tbody>
                  <tr v-for="item in gmscadastrados" :key="item.username">
                    <th class="foto-perfil"><img class="profile-user-img img-responsive img-circle" style="max-width: 30%" v-bind:src="'https://api-admin.gothicpt.com.br/Upload/User/ImagemPerfil/'+item.photo" alt="User profile picture"></th>
